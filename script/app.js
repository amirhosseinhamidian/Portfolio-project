...
function observerHandler(allSection){
    allSection.map(section=>{
        let sectoinClassName = section.target.className
        if (section.isIntersecting){
            document.querySelector(`.menu__item[data-section=${sectoinClassName}]`).classList.add('menu__item--active')
        } else {
            document.querySelector(`.menu__item[data-section=${sectoinClassName}]`).classList.remove('menu__item--active')
        }
    })
}
